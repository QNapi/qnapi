...
public:
    GeneralConfig(const QString & uiLanguage,
    ...
    const GeneralConfig setUiLanguage(const QString & uiLanguage) const {
        return GeneralConfig(uiLanguage, p7zipPath_, tmpPath_, language_, backupLanguage_, noBackup_, quietBatch_, searchPolicy_, downloadPolicy_, changePermissionsEnabled_, changePermissionsTo_);
    }
    const GeneralConfig setP7zipPath(const QString & p7zipPath) const {
        return GeneralConfig(uiLanguage_, p7zipPath, tmpPath_, language_, backupLanguage_, noBackup_, quietBatch_, searchPolicy_, downloadPolicy_, changePermissionsEnabled_, changePermissionsTo_);
    }
    const GeneralConfig setTmpPath(const QString & tmpPath) const {
        return GeneralConfig(uiLanguage_, p7zipPath_, tmpPath, language_, backupLanguage_, noBackup_, quietBatch_, searchPolicy_, downloadPolicy_, changePermissionsEnabled_, changePermissionsTo_);
    }
    const GeneralConfig setLanguage(const QString & language) const {
        return GeneralConfig(uiLanguage_, p7zipPath_, tmpPath_, language, backupLanguage_, noBackup_, quietBatch_, searchPolicy_, downloadPolicy_, changePermissionsEnabled_, changePermissionsTo_);
    }
    const GeneralConfig setBackupLanguage(const QString & backupLanguage) const {
        return GeneralConfig(uiLanguage_, p7zipPath_, tmpPath_, language_, backupLanguage, noBackup_, quietBatch_, searchPolicy_, downloadPolicy_, changePermissionsEnabled_, changePermissionsTo_);
    }
    const GeneralConfig setNoBackup(const bool & noBackup) const {
        return GeneralConfig(uiLanguage_, p7zipPath_, tmpPath_, language_, backupLanguage_, noBackup, quietBatch_, searchPolicy_, downloadPolicy_, changePermissionsEnabled_, changePermissionsTo_);
    }
    const GeneralConfig setQuietBatch(const bool & quietBatch) const {
        return GeneralConfig(uiLanguage_, p7zipPath_, tmpPath_, language_, backupLanguage_, noBackup_, quietBatch, searchPolicy_, downloadPolicy_, changePermissionsEnabled_, changePermissionsTo_);
    }
    const GeneralConfig setSearchPolicy(const SearchPolicy & searchPolicy) const {
        return GeneralConfig(uiLanguage_, p7zipPath_, tmpPath_, language_, backupLanguage_, noBackup_, quietBatch_, searchPolicy, downloadPolicy_, changePermissionsEnabled_, changePermissionsTo_);
    }
    const GeneralConfig setDownloadPolicy(const DownloadPolicy & downloadPolicy) const {
        return GeneralConfig(uiLanguage_, p7zipPath_, tmpPath_, language_, backupLanguage_, noBackup_, quietBatch_, searchPolicy_, downloadPolicy, changePermissionsEnabled_, changePermissionsTo_);
    }
    const GeneralConfig setChangePermissionsEnabled(const bool & changePermissionsEnabled) const {
        return GeneralConfig(uiLanguage_, p7zipPath_, tmpPath_, language_, backupLanguage_, noBackup_, quietBatch_, searchPolicy_, downloadPolicy_, changePermissionsEnabled, changePermissionsTo_);
    }
    const GeneralConfig setChangePermissionsTo(const QString & changePermissionsTo) const {
        return GeneralConfig(uiLanguage_, p7zipPath_, tmpPath_, language_, backupLanguage_, noBackup_, quietBatch_, searchPolicy_, downloadPolicy_, changePermissionsEnabled_, changePermissionsTo);
    }

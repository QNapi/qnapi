...
{
    diacritics = QString::fromUtf8("ąćęłńśżźĄĆĘŁŃŚŻŹŠŒŽšœžŸ¥µÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏÐÑÒÓÔÕÖØÙÚÛÜÝßàáâãäåæçèéêëìíîïðñòóôõöøùúûüýÿ");
    replacements <<"a"<<"c"<<"e"<<"l"<<"n"<<"s"<<"z"<<"z"<<"A"<<"C"<<"E"<<"L"<<"N"<<"S"<<"Z"<<"Z"<<"S"<<"OE"
